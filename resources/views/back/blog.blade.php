            ...
            <div class="items items-header-section">
                <div class="item-content">
                    ...
                    <div class="user-location">
                        <h4 style="margin-left: 0;">Blog Views</h4>
                    </div>
                        ...
                        <div class="item-content">
                            <div class="user-profile">
                                ...
                                <div class="user-meta-info">
                                    <p class="user-name" data-name="{{ $post->title }}">{{ $post->title }}</p>
                                    <p class="user-work" data-occupation="{{ $post->category->name }} | {{ $post->created_at->format('D,M y') }}">{{ $post->category->name }} | {{ $post->created_at->format('D,M y') }}</p>
                                </div>
                            </div>
                            {{-- <div class="user-email">
                                <p class="info-title">Slug: </p>
                                <p class="usr-email-addr" data-email="{{ $post->slug }}">{{ $post->slug }}</p>
                            </div> --}}
                            <div class="user-location">
                                <p class="info-title">Blog Views: </p>
                                <p class="usr-location" data-location="{{ $post->views }}">{{ $post->views }}</p>
                            </div>
                            <div class="user-phone">
                                <p class="info-title">Status: </p>
                                <p class="usr-ph-no" data-phone="{{ $post->getStatus() }}">{{ $post->getStatus() }}</p>
                            </div>
                            <div class="action-btn">
                                <a href="{{ route('blog.edit', $post->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
