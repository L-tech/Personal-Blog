			...
			<div class="row align-items-center">
				...
				<div class="col-4 d-none d-md-block d-lg-block">
					...
					<ul class="social-icons list-unstyled list-inline mb-0">
						...
						<li class="list-inline-item"><a href="https://www.youtube.com/channel/UCe_yLoXVHAEoSL4PTtke-Dg"><i class="fab fa-youtube"></i></a></li>
					</ul>
				</div>

				<div class="col-md-4 col-sm-12 col-xs-12 text-center">
				<!-- site logo -->
					<a class="navbar-brand" href="/"><img src="{{ asset('base') }}/images/a.png" alt="logo" class="main-logo" /></a>
					<a href="{{ url('about') }}" class="d-block text-logo">The Nation Builder<span class="dot">.</span></a>
					<span class="slogan d-block">Philosophy, Leadership and Development.</span>
				</div>
